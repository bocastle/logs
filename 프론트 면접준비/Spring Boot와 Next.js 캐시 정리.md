...
가능합니다.  
다만 Spring의 TTL과 완전히 같은 느낌은 아니고, **재검증 주기**에 가깝습니다.
...
Spring의 `@CacheEvict`는 보통 **캐시 엔트리를 제거**하는 느낌이 강합니다.
...
즉, Next.js에 캐시가 없는 것이 아니라,  
**Spring과 캐시의 위치와 동작 방식이 다르다**고 이해하는 것이 가장 정확합니다.
